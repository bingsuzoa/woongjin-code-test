...
class ProductServiceTest {
    ...
    private static final String PRODUCT_CODE = "PRD-ABC123";
    ...
    void getProduct_success() {
        ...
        Product product = new Product(category, ProductName.from(PRODUCT_NAME), ProductCode.from(PRODUCT_CODE));
    ...
    void createProduct_success() {
        // given
        CreateProductRequest request = new CreateProductRequest(1L, PRODUCT_NAME, PRODUCT_CODE);
        Category category = new Category(CategoryName.from("육류"));
        Product product = new Product(category, ProductName.from(PRODUCT_NAME), ProductCode.from(PRODUCT_CODE));
    ...
    void updateProduct_success() {
        ...
        Product product = new Product(category1, ProductName.from(PRODUCT_NAME), ProductCode.from(PRODUCT_CODE));
    ...
    void getProductsByCategory_success() {
        // given
        ProductDto p1 = new ProductDto(1L, 1L, "소고기", "PRD-ABC001");
        ProductDto p2 = new ProductDto(2L, 1L, "닭고기", "PRD-ABC002");
    ...
    void getProduct_notFound_throwsException() {
        ...
        assertThatThrownBy(() -> productService.getProduct(99L))
                ...
                .hasMessageContaining(ErrorCode.PRODUCT_ERROR_002.getErrorCode());
    }
    ...
    void createProduct_error() {
        ...
        assertThatThrownBy(() -> productService.createProduct(request))
                .isInstanceOf(BusinessException.class)
                .hasMessage(ErrorCode.PRODUCT_ERROR_OO1.getErrorCode());
    }
}